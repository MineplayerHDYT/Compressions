...
//==================================================================================================
    ...
    //-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=
        ...
        //------------------------------------------------------------------------------------------
            ...
            List defaultResourcePacks = ObfuscationReflectionHelper.getPrivateValue( Minecraft.class
        ...
        // - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
            ...
            ObfuscationReflectionHelper.setPrivateValue( Minecraft.class , Minecraft.getMinecraft()
                    , defaultResourcePacks , "defaultResourcePacks" );
...
//            DynamicTexture
    ...
    //-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=
        ...
        static /* Register the resource pack */ { RegisterResourcePacks(); }
